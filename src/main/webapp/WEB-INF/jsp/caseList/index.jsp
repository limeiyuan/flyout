...
<head>
    ...
    <style>
        ...
        .success_case .location {
            padding-bottom: 5px;
        }

        .success_case .location img {
            margin-right: 6px;
        }

        .success_case .location span {
            color: #999;
        }

        .success_case .case_list {
            width: 75%;
        }

        .success_case .hot_case {
            width: 23%;
        }

        .success_case .case_list > ul {
            padding: 12px;
        }

        .success_case .case_list > ul > li {
            display: inline-block;
            margin-right: 30px;
            position: relative
        }

        .success_case .case_list li input {
            border: none;
        ...
        .success_case .case_list .son_ul li {
            text-align: center;
            margin: 8px auto;
            color: #999;
            padding: 0 16px;
        ...
        .success_case .case_list .son_ul .hover {
            color: #000;
        }

        .success_case .case_list .school_filter {
            background: #ccc;
            margin: 16px auto;
            font-size: 14px;
        }

        .success_case .case_list .school_filter li {
            display: inline-block;
            width: 85px;
            text-align: center;
            height: 36px;
        ...
        .success_case .case_list .school_filter .current {
            color: #0099ec;
            cursor: pointer;
        }
        ...
        .success_case .case_list .school_case > ul {
            overflow: hidden;
        }

        .success_case .case_list .school_case > ul > li {
            float: left;
            width: 31%;
            height: 350px;
        ...
        .success_case .case_list .school_case .titeBox {
            border-bottom: 1px solid #eee;
            padding-bottom: 8px;
        }

        .success_case .case_list .school_case .titeBox p {
            font-size: 14px;
            color: #333;
        }

        .success_case .case_list .school_case .titeBox h3 {
            font-size: 18px;
            font-weight: bold;
            color: #333;
            line-height: 28px;
        ...
        .school_case .content_list {
            padding: 10px 0;
            font-size: 14px;
            color: #666;
        }

        .school_case .content_list .viewTit {
            display: inline-block;
            width: 34%;
            vertical-align: top;
        }

        .school_case .content_list .viewTitCont {
            display: inline-block;
            width: 65%;
        }

        .school_case .content_list li {
            line-height: 22px;
        }

        .school_case .content_list .gpa {
            margin-bottom: 7px;
        }

...
<head>
    ...
    <style>
        ...
        .banner .fx_banner .child { width: 1200px; margin: 0 auto; padding-top: 80px; }
        ...
        .fly_intention >ul{width: 100%;}
        .fly_intention .son_ul{background: #fff;  line-height: 20px;text-indent: 1em;}
        ...
        .fly_intention ul li .son_ul{position: absolute;width: 98.5%; z-index: 20;cursor: pointer;}
        ...
        .schoolList ul li{float: left; background: #fff; width: 32%;margin-right: 10px;}
        .schoolList ul .midd_school{margin: 0 2%;}
        .schoolList ul .school_list{position: relative;}
        .schoolList ul .school_list .hot_prof{    height: 60px;overflow:hidden;
            ...
            -webkit-line-clamp:2; }
        .schoolList ul .school_list img{width: 100%; height: 100%;}
        .schoolList ul .mask_school{position: absolute; top:0;background: rgba(0,0,0,.5);color: #fff;width: 100%; }
        ...
        .schoolList ul .mask_school .details{ width: 100px;  height: 30px;background: #0099ec;line-height: 30px;text-align: center;border-radius: 50px;cursor: pointer;}
...
<div class="schoolContent"  ng-controller="mainController">
    ...
    <div class="schoolList">
        <ul>
            <li class="school_list" ng-repeat="school in schools" ng-mouseenter="show = true" ng-mouseleave="show = false">

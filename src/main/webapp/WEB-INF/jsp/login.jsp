...
<body>
    ...
    <input name="verifCode" type="text" style="width: 60%;" maxlength="6" placeholder="输入6位校验码" ng-model="verifCode"
    ng-keyup="$event.keyCode == 13 && login()">
    </div>
    <span style="position: absolute; top: 0;right: 0;margin-top: 0px; border: 1px solid #ccc;"  ng-click="getvertf()">免费获取</span>
